...
public abstract class AbstractDefaultGoogleStyleViewLayout extends GoogleStyleViewLayout {
	...
	protected void initProperties(Context context, TypedArray attrs) {
		...
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderBackground)) {
			Drawable background = attrs.getDrawable(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderBackground);
			if ( null != background ) {
		...
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderTextAppearance)) {
			...
			attrs.getValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderTextAppearance, styleID);
			setTextAppearance(styleID.data);
		}
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrSubHeaderTextAppearance)) {
			TypedValue styleID = new TypedValue();
			attrs.getValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrSubHeaderTextAppearance, styleID);
			setSubTextAppearance(styleID.data);
		}

		// Text Color attrs need to be set after TextAppearance attrs
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderTextColor)) {
			ColorStateList colors = attrs.getColorStateList(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderTextColor);
			if (null != colors) {
				setTextColor(colors);
			}
		} else {
		...
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderSubTextColor)) {
			ColorStateList colors = attrs.getColorStateList(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrHeaderSubTextColor);
			if (null != colors) {
	...
	protected String loadPullLabel(Context context, TypedArray attrs) {
		// Pull Label
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrPullLabel)) {
			return attrs.getString(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrPullLabel);
		} 
		
		int stringId = com.handmark.pulltorefresh.library.R.string.pull_to_refresh_pull_label;
	...
	protected String loadRefreshingLabel(Context context, TypedArray attrs) {
		// Refresh Label
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrRefreshLabel)) {
			return attrs.getString(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrRefreshLabel);
		} 
		
		int stringId = com.handmark.pulltorefresh.library.R.string.pull_to_refresh_refreshing_label;
		return context.getString(stringId);
	}	
	/**
	...
	protected String loadReleaseLabel(Context context, TypedArray attrs) {
		// Release Label
		if (attrs.hasValue(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrReleaseLabel)) {
			return attrs.getString(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrReleaseLabel);
		} 
		
		int stringId = com.handmark.pulltorefresh.library.R.string.pull_to_refresh_release_label;
		return context.getString(stringId);
